    ...
    public partial class Administrator : Form
    {
      ...
      //  private readonly PrivateChat pChat;
        ...
        private void mButtonDisable_Click(object sender, EventArgs e)
        {
            ...
            string query = "Update [Table] SET cheie='false' Where Username=" + mTextBoxUserForBan.Text.Trim();

            SqlDataAdapter sda = new SqlDataAdapter(query, con);

            formLogin.Client.Send("Ban|" + formLogin.getUser() + "|" + mTextBoxUserForBan.Text.Trim());
        }
