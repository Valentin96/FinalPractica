...
namespace AdministratorForm
{
    ...
    //    private readonly PrivateChat pChat;
        ...
        private void mButtonDisable_Click(object sender, EventArgs e)
        {
            //send input for options
            SqlConnection con = new SqlConnection(@"Data Source=.;Initial Catalog=Chat;Integrated Security=True");
            string query = "Update [Table] SET cheie='false' Where Username=" + mUserNameBan.Text.Trim();

            SqlDataAdapter sda = new SqlDataAdapter(query, con);

            formLogin.Client.Send("Ban|" + formLogin.getUser() + "|" + mUserNameBan.Text.Trim());
        }

        private void mTextBoxUserForBan_TextChanged(object sender, EventArgs e)
        {

        }

        private void mListBoxUsersList_SelectedIndexChanged_1(object sender, EventArgs e)
        {

        }

        private void mUserNameBan_TextChanged(object sender, EventArgs e)
        {

        }

        private void mButtonBan_Click(object sender, EventArgs e)
        {

        }

        private void mButtonUnban_Click(object sender, EventArgs e)
        {

        }

        private void mTextBoxLogs_TextChanged(object sender, EventArgs e)
        {

        }

        private void mButtonLogs_Click(object sender, EventArgs e)
        {

        }

        private void mTextBoxReceiveMessages_TextChanged_1(object sender, EventArgs e)
        {

        }

        private void mTextBoxInput_TextChanged_1(object sender, EventArgs e)
        {

        }

        private void mButtonSend_Click_1(object sender, EventArgs e)
        {
